...
namespace SimpleQuiz.Backend
{
    ...
    public interface IQuestionProvider
    {
        ...
        /// <returns></returns>
        Task<IEnumerable<Question>> GetFixedQuestionList(int questionCount, Shuffling shuffling);
        ...
        /// <param name="shuffling">Indicates whether the questions and/or answers should be shuffled.</param>
        /// <returns></returns>
        Task<IEnumerable<Question>> GetRandomQuestionList(int questionCount, Shuffling shuffling);
    }
